...
- [ ] 4. TG 机器人
  - [ ] 4.1 telegramBot.ts 基础框架
    - 新建 `src/server/telegramBot.ts`（grammY 长轮询）：读取 telegram.enable/botToken，初始化命令路由与用户绑定状态（对应需求 R6）
...
- [ ] 5. 版本升级与交付
  ...
  - [ ] 5.3 构建推送镜像 3.0.2 并提交推送 fork 分支
